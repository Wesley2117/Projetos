...
import { Bell, Home, Library, Menu, Mic, Search, Tv, Video } from "lucide-react"
  ...
  return (
    <div className="flex h-screen flex-col">
      <header className="flex items-center justify-between border-b px-4 py-2">
        ...
        <div className="flex w-full max-w-xl items-center space-x-2">
          <form className="flex w-full items-center">
            <Input
              className="w-full rounded-l-full rounded-r-none border-r-0 pl-4"
              placeholder="Search"
              type="search"
            />
            <Button className="rounded-l-none rounded-r-full" type="submit" variant="outline">
      ...
      <div className="flex flex-1 overflow-hidden">
        <aside className="w-60 flex-shrink-0 overflow-y-auto border-r">
                ...
                <div key={index} className="space-y-3">
                  ...
                  <div className="flex space-x-3">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-xs text-gray-500 dark:text-gray-400">1M views • 3 months ago</p>
                    </div>
                  </div>
                </div>
              ))}
